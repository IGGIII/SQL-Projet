...
CREATE TABLE `analyse` (
  ...
  PRIMARY KEY (`id_rapport`,`id_mesure`),
  KEY `id_mesure` (`id_mesure`),
  CONSTRAINT `analyse_ibfk_1` FOREIGN KEY (`id_mesure`) REFERENCES `mesure` (`id_mesure`),
  CONSTRAINT `analyse_ibfk_2` FOREIGN KEY (`id_rapport`) REFERENCES `ressources_humaines` (`id_employe`)
...
INSERT INTO `analyse` VALUES (5,1),(12,10),(34,5),(45,3),(54,9),(75,2),(99,4),(111,8),(126,7),(198,6);
